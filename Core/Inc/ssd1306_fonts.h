 ...
 * @brief   Font data for SSD1306 OLED driver
 * @note    6x8 pixel font covering ASCII 32-126
 *          Each character is 6 columns wide, 8 rows tall (1 page).
 *          Data is column-major: font[ch][0..4] = 5 data columns,
 *          font[ch][5] = 0x00 (spacing column).
